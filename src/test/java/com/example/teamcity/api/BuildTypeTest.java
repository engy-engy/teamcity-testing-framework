...
public class BuildTypeTest extends BaseApiTest {
    ...
    public void projectAdminCannotCreateBuildTypeForAnotherUserProjectTest(){
        ...
        var buildType = userAuthSpec.getRequest(BUILD_TYPES).create(testData.getBuildType());
        ...
        var userAuthSpec2 = new CheckedRequests(Specifications.authSpec(testData.getUser()));
        ...
        userAuthSpec2.getRequest(BUILD_TYPES).create(buildType2);
...
/*
    ...
    @Test(description = "Project admin should not be able to create project type for not their project", groups = {"Negative","Roles "})
